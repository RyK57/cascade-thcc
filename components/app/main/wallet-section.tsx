  ...
  return (
    ...
    >
      ...
      <p className="mt-3 max-w-[56ch] text-sm leading-relaxed text-muted-foreground">
        Dynamic is the payment rail. Sign in with an email address and an
        embedded wallet is created for you — no card on file, no seed phrase to
        keep. It funds the jobs you confirm, and nothing else.
      </p>
